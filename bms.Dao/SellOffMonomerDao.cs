...
namespace bms.Dao
{
    public class SellOffMonomerDao
    {
        ...
        {
            string sql = "select number,state from v_allsalemonomer where bookNum=@bookNum and saleTaskId=@saleTaskId";
