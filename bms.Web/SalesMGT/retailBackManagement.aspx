<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retailBackManagement.aspx.cs" Inherits="bms.Web.SalesMGT.retailBackManagement" %>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-danger">
                                    <h4 class="card-title">零退管理</h4>
                                </div>
                                <div class="card-body">
                                    <div class="card-header from-group">
                                        <div class="input-group">
                                            <div class="btn-group" role="group">
                                                <a class="btn btn-success btn-sm" href="retailBack.aspx" id="btn-add">添加</a>
                                            </div>
                                        </div>
                                    </div>
