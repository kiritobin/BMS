<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retailBackQuery.aspx.cs" Inherits="bms.Web.SalesMGT.retailBackQuery" %>
...
<body>
                    ...
                    <li class="nav-item active">
                        ...
                        <div class="collapse show" id="saleManage">
                            <ul class="nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link activeNext" href="retailBackManagement.aspx" id="retailBack">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table_stock text-right">
                                        <tr class="text-nowrap">
                                            ...
                                            <td>
                                                <input value="<%=single.SaleHeadId %>" class="form-control" disabled>
                                            </td>
                                            <td>
                                                <span>操作员:</span>
                                            </td>
                                            <td>
                                                <input value="<%=single.UserName %>" class="form-control" disabled>
                                            </td>
                                            <td>
                                                <span>单据总数:</span>
                                            </td>
                                            <td>
                                                <input type="text" value="<%=single.Number %>" class="form-control" disabled>
                                            </td>
                                        </tr>
                                        <tr class="text-nowrap">
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" value="<%=single.RegionName %>" class="form-control" disabled></td>
                                            <td>
                                                <span>总码洋:</span>
                                            </td>
                                            <td>
                                                <input type="text" value="<%=single.AllTotalPrice %>" class="form-control" disabled>
                                            </td>
                                            <td>
                                                <span>总实洋:</span>
                                            </td>
                                            <td>
                                                <input type="text" value="<%=single.AllRealPrice %>" class="form-control" disabled>
                                            </td>
                                        </tr>
                                        <tr class="text-nowrap">
                                            <td>
                                            ...
                                            <td>
                                                <div class="jeinpbox">
                                                    <input type="text" value="<%=single.DateTime %>" class="form-control" disabled id="test2">
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
    ...
    <script src="../js/retailBackQuery.js"></script>
