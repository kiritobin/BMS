...
<body>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="retailList col-md-2">
                            ...
                            <hr />
                            <div class="input-group text-white" id="scanning">
                                <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal1"><i class="fa fa-qrcode">扫描</i></a>
                            </div>
                            <div class="input-group text-white" id="Settlement">
                                <a class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal2"><i class="fa fa-jpy">收银</i></a>
                            </div>
                    </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title float-left" id="myModalLabel2">结算信息如下</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        <i class="material-icons">clear</i>
                    </button>
                </div>
                <div class="modal-body">
                    <h3 class="text-center">结算小票</h3>
                        <hr />
                        <ul class="list-unstyled">
                            <li>种类：<span id="kindEnd"></span></li>
                            <li>数量：<span id="numberEnd"></span></li>
                            <li>折扣：<span id="discountEnd"></span></li>
                            <li>总码洋：<span id="totalEnd"></span></li>
                            <li>总实洋：<span id="realEnd"></span></li>
                            <li>时间：<span id="timeEnd"></span></li>
                        </ul>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-success btn-sm" id="btnSettle">提交</button>
                </div>
            </div>
        </div>
    </div>
