...
function MyPreview() {
    ...
    for (i = 1; i < j; i++) {
        ...
        LODOP.ADD_PRINT_LINE(iCurLine - 50, 795, iCurLine - 50 + 45 * i, 795, 0, 1);
        LODOP.ADD_PRINT_LINE(iCurLine - 50, 880, iCurLine - 50 + 45 * i, 880, 0, 1);
    }
...
function AddTitle() {
    ...
    LODOP.ADD_PRINT_TEXT(15, 200, 355, 30, "销退明细打印");
    LODOP.SET_PRINT_STYLEA(5, "FontSize", 24);
