...
function MyPreview() {
    ...
    for (i = 1; i < j; i++) {
        ...
        if (row.eq(i).find('td').eq(11).text().trim().length > 10) {
            LODOP.ADD_PRINT_TEXT(iCurLine, 730, 70, 20, row.eq(i).find('td').eq(11).text().trim());
            LODOP.SET_PRINT_STYLEA(0, "FontSize", 6);
            LODOP.SET_PRINT_STYLEA(0, "Bold", 0);
        }
        else {
        ...
        LODOP.ADD_PRINT_TEXT(iCurLine, 800, 100, 20, row.eq(i).find('td').eq(12).text().trim());
        iCurLine = iCurLine + 45;//每行占25px
        LODOP.ADD_PRINT_LINE(iCurLine - 5, 14, iCurLine - 5, 880, 0, 1);//横线
        //竖线
        ...
        LODOP.ADD_PRINT_LINE(iCurLine - 50, 795, iCurLine - 50 + 45, 795, 0, 1);
        LODOP.ADD_PRINT_LINE(iCurLine - 50, 880, iCurLine - 50 + 45, 880, 0, 1);
    }
    LODOP.ADD_PRINT_LINE(iCurLine, 14, iCurLine, 880, 0, 1);
...
function AddTitle() {
    LODOP = getLodop();
    LODOP.PRINT_INIT("零售明细");
    LODOP.SET_PRINT_PAGESIZE(3, 2000, 100, "");
    LODOP.ADD_PRINT_TEXT(5, 350, 121, 30, "零售明细");
    ...
    LODOP.ADD_PRINT_TEXT(50, 685, 100, 20, "收银员");
    LODOP.ADD_PRINT_TEXT(50, 730, 100, 20, "供应商");
    LODOP.ADD_PRINT_TEXT(50, 800, 80, 20, "支付方式");
    //横线
    LODOP.ADD_PRINT_LINE(45, 14, 45, 880, 0, 1);
    LODOP.ADD_PRINT_LINE(75, 14, 75, 880, 0, 1);
    //竖线
    ...
    LODOP.ADD_PRINT_LINE(45, 795, 75, 795, 0, 1);
    LODOP.ADD_PRINT_LINE(45, 880, 75, 880, 0, 1);
};