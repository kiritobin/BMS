        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (status != "" || status != null) {
                    ...
                    LODOP = getLodop();
                    LODOP.PRINT_INITA(0, 0, 577, 10000, $("#sourceRegin").val() + "   入库单");
                    LODOP.ADD_PRINT_TEXT(30, 200, 600, 30, $("#sourceRegin").val() + "   入库单");
                    ...
                    for (i = 0; i < j - 1; i++) {
                        ...
                        if (row.eq(2).text().trim().length > 20) {
                            LODOP.ADD_PRINT_TEXT(235 + 25 * i, 170, 270, 20, row.eq(2).text().trim());
...
$("#export").click(function () {
    window.location.href = "checkStock.aspx?op=export";
})
