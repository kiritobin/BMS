...
namespace bms.Web.ReportStatistics
{
    public partial class returnDetails : System.Web.UI.Page
    {
        ...
        public void export()
        {
            string Name = name + "-退货明细-" + DateTime.Now.ToString("yyyyMMdd") + new Random(DateTime.Now.Second).Next(10000);
            DataTable dt = wareBll.ExportExcelDetails(groupType, type, 2);
