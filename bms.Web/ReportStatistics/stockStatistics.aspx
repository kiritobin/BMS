<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stockStatistics.aspx.cs" Inherits="bms.Web.ReportStatistics.stockStatistics" %>
                                ...
                                <div class="card-body">
                                    <div class="card-header" style="padding-right: 0px;">
                                        <div class="input-group">
                                            ...
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-info" id="print" data-toggle="modal">打印报表</button>
                                            </div>
                                        </div>
                                    </div>
