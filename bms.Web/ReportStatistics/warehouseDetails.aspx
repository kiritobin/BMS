<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="warehouseDetails.aspx.cs" Inherits="bms.Web.ReportStatistics.warehouseDetails" %>
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <ul class="breadcrumb">
                    ...
                    <li><a href="warehouseStatistics.aspx">出库统计</a></li>
                                ...
                                <div class="card-body">
                                    <div class="card-header" style="padding-right: 0px;">
                                        <form class="form-inline">
                                            ...
                                            &nbsp;
                                            <div class="form-group form-group-sm">
                                                <input type="text" class="" placeholder="请输入时间段" id="time" data-toggle="modal" data-target="#myModal" style="width: 130px; height: 34px" />
                                            </div>
                                            &nbsp;
                                            <div class="form-group form-group-sm">
